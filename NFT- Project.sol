...
contract NFTToken is ERC721, ERC721URIStorage, Pausable, Ownable {
   ...
   uint256 private  whiteListedUserLimit;
    ...
    event AdminSale(uint256 indexed nftID, address indexed seller, uint transactionTime);
    
    /**
    * To add details of NFT and to safe the record, we use struct of NFT
    */
    ...
    /**
    * safe records against a unique ID
    */
        ...
        returns (string memory)
    {
      ...
      /**
    * whitelisting minting can be occur within a specific time period, this method will show the remaining time period of whitelisting minting
    */
    ...
    /**
    * Here we set WhiteListers by owner, and only owner can set whitlisters and deavtivate them
    */
    ...
    function WhiteListerMintNFTDetails(
        ...
        emit WhitelisterSale(_NFTID, msg.sender, block.timestamp, endTime - block.timestamp);
        countForWhiteListers++;
        
    
    }
        /**
    * The remaining limit of whitelisting will be added into public minting, this method is only for some testing. 
    */
    ...
    function showPublicMintingLimit() public view returns(uint) {
        ...
        /**
    * Anyone can mint through this method
    */
    function PublicMintNFTDetails(
        ...
        mintwithDetail(_NFTID, _NFTName, _hash);
        emit PublicSale(_NFTID, msg.sender, block.timestamp);
    ...
    function AdminMintNFTDetails(
        ...
        mintwithDetail(_NFTID, _NFTName, _hash);
        emit AdminSale(_NFTID, msg.sender, block.timestamp);
        countAdmin++;
    }
